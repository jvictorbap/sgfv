    ...
    public partial class Ferramentas : Form
    {
        ...
        private void Ferramentas_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "SELECT * FROM TB_GastosFerramentas";
        ...
        private void xuiButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "INSERT INTO TB_GastosFerramentas (NOMEGASTO, VALORGASTO, DATA) VALUES (@NOMEGASTO, @VALORGASTO, @DATA)";
        ...
        private void xuiButton2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "DELETE FROM TB_GastosFerramentas WHERE ID = @ID";
        ...
        private void xuiButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "UPDATE TB_GastosFerramentas SET NOMEGASTO = @NOMEGASTO, VALORGASTO = @VALORGASTO WHERE ID = @ID";
                comando = new SqlCommand(strSQL, conexao);
