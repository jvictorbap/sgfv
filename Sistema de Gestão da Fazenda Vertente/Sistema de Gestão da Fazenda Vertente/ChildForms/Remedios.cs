    ...
    public partial class Remedios : Form
    {
        ...
        private void xuiButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "INSERT INTO TB_GastosRemedio (NOMEGASTO, VALORGASTO, DATA) VALUES (@NOMEGASTO, @VALORGASTO, @DATA)";
                ...
                strSQL = "SELECT * FROM TB_GastosRemedio";
        ...
        private void Remedios_Load(object sender, EventArgs e)
        {
            try
            {
                conexao = new SqlConnection(@"Server=DESKTOP-BI7MMRS\SQLEXPRESS;Database=DB_Gestao;User Id=sa;Password=123456;");
        ...
        private void xuiButton2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "DELETE FROM TB_GastosRemedio WHERE ID = @ID";
        ...
        private void xuiButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "UPDATE TB_GastosRemedio SET NOMEGASTO = @NOMEGASTO, VALORGASTO = @VALORGASTO WHERE ID = @ID";
                comando = new SqlCommand(strSQL, conexao);
