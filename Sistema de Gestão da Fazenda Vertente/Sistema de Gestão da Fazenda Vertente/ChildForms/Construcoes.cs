...
{
    public partial class Construcoes : Form
    {
        ...
        private void xuiButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "INSERT INTO TB_GastosConstrucoes (NOMEGASTO, VALORGASTO, DATA) VALUES (@NOMEGASTO, @VALORGASTO, @DATA)";
        ...
        private void xuiButton2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "DELETE FROM TB_GastosConstrucoes WHERE ID = @ID";
        ...
        private void xuiButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "UPDATE TB_GastosConstrucoes SET NOMEGASTO = @NOMEGASTO, VALORGASTO = @VALORGASTO WHERE ID = @ID";
                comando = new SqlCommand(strSQL, conexao);
